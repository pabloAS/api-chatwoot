    ...
    Sender.prototype.sendText = function (to, body) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        // this.sendText("5551992225363@c.us", "ola tudo bem ? Esse é um teste");
                        if (!(0, libphonenumber_js_1.isValidPhoneNumber)(to, "BR")) {
                            throw new Error("o numero não é valido");
                        }
                        phoneNumber = (_b = (_a = (0, libphonenumber_js_1.default)(to, "BR")) === null || _a === void 0 ? void 0 : _a.format("E.164")) === null || _b === void 0 ? void 0 : _b.replace("+", "");
